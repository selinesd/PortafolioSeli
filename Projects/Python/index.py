...
def opciones_precio_vuelo_ida(pais, fecha_ida):
    ...
    if pais == "Cuba":
        ...
        print("1. Vuelo DO - CU   $145")
    elif pais == "Jamaica":
        print("1. Vuelo DO - JA   $130")
        print("2. Vuelo DO - JA   $145")
    elif pais == "Puerto Rico":
        print("1. Vuelo DO - PR   $130")
        print("2. Vuelo DO - PR   $145")
    elif pais == "Bahamas":
        print("1. Vuelo DO - BA   $130")
        print("2. Vuelo DO - BA   $145")
    elif pais == "Haiti":
        print("1. Vuelo DO - HA   $130")
        print("2. Vuelo DO - HA   $145")
    elif pais == "Barbados":
        print("1. Vuelo DO - BR   $130")
        print("2. Vuelo DO - BR   $145")
...
def opciones_precio_vuelo_regreso(pais):
    ...
    if pais == "Cuba":
        ...
        print("1. Vuelo CU - DO   $190")
    elif pais == "Jamaica":
        print("1. Vuelo JA - DO   $180")
        print("2. Vuelo JA - DO   $190")
    elif pais == "Puerto Rico":
        print("1. Vuelo PR - DO   $180")
        print("2. Vuelo PR - DO   $190")
    elif pais == "Bahamas":
        print("1. Vuelo BA - DO   $180")
        print("2. Vuelo BA - DO   $190")
    elif pais == "Haiti":
        print("1. Vuelo HA - DO   $180")
        print("2. Vuelo HA - DO   $190")
    elif pais == "Barbados":
        print("1. Vuelo BR - DO   $180")
        print("2. Vuelo BR - DO   $190")
    elif pais == "Trinidad y Tobago":
...
def opciones_precio_vuelo_ida(pais, fecha_ida):
    ...
    if pais == "Guatemala":
        print("1. Vuelo DO - GU   $130")
        print("1. Vuelo DO - GU   $145")
    elif pais == "El Salvador":
        print("1. Vuelo DO - SA   $130")
        print("2. Vuelo DO - SA   $145")
    elif pais == "Honduras":
        print("1. Vuelo DO - HO   $130")
        print("2. Vuelo DO - HO   $145")
    elif pais == "Nicaragua":
        print("1. Vuelo DO - NI   $130")
        print("2. Vuelo DO - NI   $145")
    elif pais == "Costa Rica":
        print("1. Vuelo DO - CR   $130")
        print("2. Vuelo DO - CR   $145")
    elif pais == "Panamá":
        print("1. Vuelo DO - PA   $130")
        print("2. Vuelo DO - PA   $145")
    elif pais == "Belice":
...
def opciones_precio_vuelo_regreso(pais):
    ...
    if pais == "Guatemala":
        print("1. Vuelo GU - DO   $180")
        print("1. Vuelo GU - DO   $190")
    elif pais == "El Salvador":
        print("1. Vuelo SA - DO   $180")
        print("2. Vuelo SA - DO   $190")
    elif pais == "Honduras":
        print("1. Vuelo HO - DO   $180")
        print("2. Vuelo HO - DO   $190")
    elif pais == "Nicaragua":
        print("1. Vuelo NI - DO   $180")
        print("2. Vuelo NI - DO   $190")
    elif pais == "Costa Rica":
        print("1. Vuelo CR - DO   $180")
        print("2. Vuelo CR - DO   $190")
    elif pais == "Panamá":
        print("1. Vuelo PA - DO   $180")
        print("2. Vuelo PA - DO   $190")
    elif pais == "Belice":
...
def opciones_precio_vuelo_ida(pais, fecha_ida):
    ...
    if pais == "Alabama":
        print("1. Vuelo DO - AL   $130")
        print("1. Vuelo DO - AL   $145")
    elif pais == "Alaska":
        print("1. Vuelo DO - AK   $130")
        print("2. Vuelo DO - AK   $145")
    elif pais == "Arizona":
        print("1. Vuelo DO - AR   $130")
        print("2. Vuelo DO - AR   $145")
    elif pais == "Arkansas":
        print("1. Vuelo DO - AS   $130")
        print("2. Vuelo DO - AS   $145")
    elif pais == "California":
        print("1. Vuelo DO - CF   $130")
        print("2. Vuelo DO - CF   $145")
    elif pais == "Colorado":
        print("1. Vuelo DO - CO   $130")
        print("2. Vuelo DO - CO   $145")
    elif pais == "Connecticut":
        print("1. Vuelo DO - CC   $130")
        print("2. Vuelo DO - CC   $145")
    elif pais == "Delaware":
        print("Vuelo DO - DW   $130")
        print("Vuelo DO - DW   $145")
    elif pais == "Florida":
        print("Vuelo DO - FL   $130")
        print("Vuelo DO - FL   $145")
    elif pais == "Georgia":
        print("Vuelo DO - GEO   $130")
        print("Vuelo DO - GEO   $145")
    elif pais == "Hawái":
        print("Vuelo DO - HW   $130")
        print("Vuelo DO - HW   $145")
...
def opciones_precio_vuelo_regreso(pais):
    ...
    if pais == "Alabama":
        print("1. Vuelo AL - DO   $130")
        print("1. Vuelo AL - DO   $145")
    elif pais == "Alaska":
        print("1. Vuelo AK - DO   $130")
        print("2. Vuelo AK - DO   $145")
    elif pais == "Arizona":
        print("1. Vuelo AR - DO   $130")
        print("2. Vuelo AR - DO   $145")
    elif pais == "Arkansas":
        print("1. Vuelo AS - DO   $130")
        print("2. Vuelo AS - DO   $145")
    elif pais == "California":
        print("1. Vuelo CF - DO   $130")
        print("2. Vuelo CF - DO   $145")
    elif pais == "Colorado":
        print("1. Vuelo CO - DO   $130")
        print("2. Vuelo CO - DO   $145")
    elif pais == "Connecticut":
        print("1. Vuelo CC - DO   $130")
        print("2. Vuelo CC - DO   $145")
    elif pais == "Delaware":
        print("Vuelo DW - DO   $130")
        print("Vuelo DW - DO   $145")
    elif pais == "Florida":
        print("Vuelo FL - DO   $130")
        print("Vuelo FL - DO   $145")
    elif pais == "Georgia":
        print("Vuelo GEO - DO   $130")
        print("Vuelo GEO - DO   $145")
    elif pais == "Hawái":
        print("Vuelo HW - DO   $130")
        print("Vuelo HW - DO   $145")
...
def opciones_precio_vuelo_regreso(pais):
    ...
    if pais == "Brasil":
        print("1. Vuelo AL - DO   $180")
        print("1. Vuelo AL - DO   $190")
    elif pais == "Argentina":
        print("1. Vuelo AK - DO   $180")
        print("2. Vuelo AK - DO   $190")
    elif pais == "Colombia":
        print("1. Vuelo AR - DO   $180")
        print("2. Vuelo AR - DO   $190")
    elif pais == "Perú":
        print("1. Vuelo AS - DO   $180")
        print("2. Vuelo AS - DO   $190")
    elif pais == "Venezuela":
        print("1. Vuelo CF - DO   $180")
        print("2. Vuelo CF - DO   $190")
    elif pais == "Chile":
        print("1. Vuelo CO - DO   $180")
